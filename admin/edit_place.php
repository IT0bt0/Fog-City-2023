...
$records = mysqli_query($con,"select * from places where id='$id'");
...
<style>
    ...
    font-size: 100%;
    background: url('https://previews.123rf.com/images/dizanna/dizanna1706/dizanna170600150/79904145-admin-word-cloud-concept.jpg') no-repeat center top;
...
<div class="flight">
    ...
    <div class="booking-form-w3layouts">
		<!-- Form starts here -->
		<form action="../backend/add_place.php" method="post" enctype="multipart/form-data">
			<h2 class="sub-heading-agileits">Edit Place Details</h2>
			<div class="main-flex-w3ls-sectns">
				...
				<div class="field-agileinfo-spc form-w3-agile-text2">
					...
					<input type="text" name="location" value="<?php echo $data['location'] ?>" required class="form-control">
				</div>
			</div>
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<label for="">Place Fees</label>
					<input type="text" name="price" value="<?php echo $data['price'] ?>" required class="form-control">
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<label for="">Place Description</label>
					<input type="text" name="description" value="<?php echo $data['description'] ?>" required class="form-control">
				</div>
			</div>
