...
if(isset($_POST['delete'])) {
    ...
    echo '<script type="text/javascript"> alert("Deleted Successfully!"); window.location.href="places.php";</script>';  // alert message
}
?>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="section">
                <div class="img"><img src="../places/<?php echo $data['id'] ?>/<?php echo $data['file'] ?>" width="100%" height="250px" alt=""></div>
                ...
                <a href="edit_place.php?id=<?php echo $data['id'] ?>" class="btn btn-warning btn-block">Edit Place</a>
                <form action="events.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                    <button type="submit" name="delete" class="button btn-danger btn-block">Delete Place</button>
                </form>
