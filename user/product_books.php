...
$records = mysqli_query($con,"select p.*, b.tickets, b.timedate from products p, poduct_books b where p.id=b.pid and b.uid='$user'");
...
<div class="col-md-4">
    <div class="card">
        ...
        <hr>
        <span>Product Price: <?php echo $data['price']?> SR</span>
        </div>
    </div>
</div>
<?php
