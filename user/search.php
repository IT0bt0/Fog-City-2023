...
$records = mysqli_query($con,"select * from events where place='$city' and price > '$budget' order by price");
$records1 = mysqli_query($con,"select * from places where place='$city' and price > $budget order by price");
$records2 = mysqli_query($con,"select * from products where place='$city' and price > $budget order by price");
$records3 = mysqli_query($con,"select * from resturants where place =  '$city'");
?>
...
<div class="container flights">
    ...
    font-size: 30px;
    padding: 10px;
    border-radius: 10px;">Resturants</b>
    <hr>
    <?php
    ...
    ?>
        <div class="col-md-4">
            <div class="card">
                <div class="section">
                    <div class="img"><img src="../events/<?php echo $data['id'] ?>/<?php echo $data['file'] ?>" width="100%" height="250" alt=""></div>
                    ...
                    <a href="<?php echo $data['location'] ?>" target="_blank" class="button btn-warning">Location</a>
                    <a href="pay_event.php?id=<?php echo $data['id'] ?>" target="_blank" class="button btn-danger">Book Now</a>
                </div>
            </div>
        </div>
    <?php
