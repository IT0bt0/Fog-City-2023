...
$records = mysqli_query($con,"select e.*, b.tickets, b.timedate from events e, event_books b where e.id=b.eid and b.uid='$user'");
...
<div class="col-md-4">
    <div class="card">
        ...
        <hr>
        <span># of Tickects: <?php echo $data['tickets'] ?></span>
        <br>
        <span>Date/Time: <?php echo $data['timedate'] ?></span>
        <dl class="info">
