...
$records = mysqli_query($con,"select * from products where id='$id'");
...
<style>
    ...
    font-size: 100%;
    background: url('../images/fcover.jpeg') no-repeat center top;
...
<div class="flight">
    ...
    <div class="booking-form-w3layouts">
		...
		<form action="../backend/add_product.php" method="post" enctype="multipart/form-data">
			<h2 class="sub-heading-agileits">Edit Product Details</h2>
