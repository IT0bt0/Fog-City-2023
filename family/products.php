...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="section">
                <div class="img"><img src="../products/<?php echo $data['id'] ?>/<?php echo $data['file'] ?>" width="100%" height="250px" alt=""></div>
                ...
                <a href="edit_product.php?id=<?php echo $data['id'] ?>" class="btn btn-warning btn-block">Edit Product</a>
                <form action="products.php" method="post">
                    <button type="submit" name="delete" class="button btn-danger btn-block">Delete Product</button>
                </form>
