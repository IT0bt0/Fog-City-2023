...
$records = mysqli_query($con,"select * from events where id='$id'");
...
<style>
    ...
    font-size: 100%;
    background: url('https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX17389261.jpg') no-repeat center top;
...
<div class="flight">
    ...
    <div class="booking-form-w3layouts">
		<!-- Form starts here -->
		<form action="../backend/add_event.php" method="post" enctype="multipart/form-data">
			<h2 class="sub-heading-agileits">Edit Event Details</h2>
