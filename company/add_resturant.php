...
<div class="flight">
    ...
    <div class="booking-form-w3layouts">
		...
		<form action="../backend/add_resturant.php" method="post" enctype="multipart/form-data">
			<h2 class="sub-heading-agileits">Resturant Details</h2>
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<label for="place">Resturant Place</label>
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1" style="-webkit-flex-basis:100%;">
			...
			<div class="clear"></div>
			<input type="submit" value="Submit" name="resturant">
			<div class="clear"></div>
		</form>
		<!--// Form starts here -->
	</div>
