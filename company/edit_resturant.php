...
$records = mysqli_query($con,"select * from resturants where id='$id'");
...
<style>
    ...
    font-size: 100%;
    background: url('https://static.sayidaty.net/2022-08/144803.png') no-repeat center top;
...
<div class="flight">
    ...
    <div class="booking-form-w3layouts">
		<!-- Form starts here -->
		<form action="../backend/add_resturant.php" method="post" enctype="multipart/form-data">
			<h2 class="sub-heading-agileits">Edit Resturant Details</h2>
			...
			<div class="main-flex-w3ls-sectns">
				...
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<label for="">Resturant Description</label>
